...
DealerPointRefresh(id)
{
	if(id != -1)
	{
		...
		{
			format(tstr, sizeof(tstr), "[DEALERSHIP: %d]\n"WHITE_E"%s Spawn Point", id, DealerData[id][dealerName]);
			DealerData[id][dealerPointLabel] = CreateDynamic3DTextLabel(tstr, COLOR_AQUA, DealerData[id][dealerPointX], DealerData[id][dealerPointY], DealerData[id][dealerPointZ], 5.0);
...
DealerRefresh(id)
{
	if(id != -1)
	{
		...
		{
			format(tstr, sizeof(tstr), "[ID: %d]\n"WHITE_E"Dealer: {7fffd4}%s\n"WHITE_E"Owner: {7fffd4}%s\n"WHITE_E"Type: {7fffd4}%s\n\n"GREY_E"/buypv", id, DealerData[id][dealerName], DealerData[id][dealerOwner], type);
			DealerData[id][dealerLabel] = CreateDynamic3DTextLabel(tstr, COLOR_AQUA, DealerData[id][dealerPosX], DealerData[id][dealerPosY], DealerData[id][dealerPosZ], 5.0);
		...
		{
			format(tstr, sizeof(tstr), "[ID: %d]\n"AQUA"DEALERSHIP SELL\n\n"WHITE_E"Location: {7fffd4}%s\n"WHITE_E"Price: {7fffd4}s\n"WHITE_E"Type: "AQUA"%s", id, GetLocation(DealerData[id][dealerPosX], DealerData[id][dealerPosY], DealerData[id][dealerPosZ]), FormatMoney(DealerData[id][dealerPrice]), type);
			DealerData[id][dealerLabel] = CreateDynamic3DTextLabel(tstr, COLOR_AQUA, DealerData[id][dealerPosX], DealerData[id][dealerPosY], DealerData[id][dealerPosZ], 5.0);
            DealerData[id][dealerPickup] = CreateDynamicPickup(1239, 23, DealerData[id][dealerPosX], DealerData[id][dealerPosY], DealerData[id][dealerPosZ]);
   		}
