	...
	{	
		...
		foreach(new i: PVehicles)
		{
			if(x == pvData[i][cVeh])
			{
				...
				ShowPlayerDialog(playerid, DIALOG_VTOYBUY, DIALOG_STYLE_LIST, ""RED_E"Adv-Rp: "WHITE_E"Vehicle Toys", string, "Select", "Cancel");
			}
		}
	}
...
CMD:vtoys(playerid)
{
	...
	{	
		...
		if(x == pvData[i][cVeh])
		{
			...
			ShowPlayerDialog(playerid, DIALOG_VTOY, DIALOG_STYLE_LIST, ""RED_E"ILRP: "WHITE_E"Vehicle Toys", string, "Select", "Cancel");
		}
	}
	else return Error(playerid, "Anda harus mengendarai kendaraan!");
