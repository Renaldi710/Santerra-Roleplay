...
SaveFarm(id)
{
	...
	farmData[id][farmLeader],
	farmData[id][farmMotd]);
	...
	dquery,
	farmData[id][FarmSposX],
	farmData[id][FarmSposY],
	farmData[id][FarmSposZ],
	farmData[id][FarmRepX],
	farmData[id][FarmRepY],
	farmData[id][FarmRepZ],
