...
public CargoMeat(playerid)
{
	...
	SCM(playerid, COLOR_JOB, "TRUCKER BOX:"WHITE_E"You Have purchase a Cargo of "YELLOW_E"Meat "WHITE_E"for "GREEN_E"$5");
...
CMD:cargo(playerid, params[])
{
	if(IsPlayerConnected(playerid))
	{
		...
		{
            if(IsPlayerInRangeOfPoint(playerid, 3.0, 2228.3291, -2268.3794, 14.7647))//Type Meat
			{
        ...
        {
   	    	new string [256];
 			if(IsPlayerInRangeOfPoint(playerid, 4.0, 83.5759, -187.7058, 1.5411))//Meat
 			{
				if(IsPlayerInAnyVehicle(playerid)) return Error(playerid, "Don't use this in vehicle");
				{
