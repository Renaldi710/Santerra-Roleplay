...
CreateServerPoint()
{
	...
	ProductPickup = CreateDynamicPickup(1239, 23, -133.5227, -326.1761, 1.4219, -1, -1, -1, 5.0);
	...
	ProductText = CreateDynamic3DTextLabel(strings, COLOR_LOGS, -133.5227, -326.1761, 1.4219, 5.0); // product
	
	ApotekPickup = CreateDynamicPickup(1239, 23, 1256.2795, -1281.5076, 1061.1492, -1, -1, -1, 5.0);
	format(strings, sizeof(strings), "[Hospital]\n"WHITE_E"Apotek Stock: "LG_E"%d\n"LB_E"/buy", Apotek);
	ApotekText = CreateDynamic3DTextLabel(strings, COLOR_PINK, 1256.2795, -1281.5076, 1061.1492, 5.0); // Apotek hospital
	...
	DrugPickup = CreateDynamicPickup(1239, 23, -2813.33, -1516.67, 141.144, -1, -1, -1, 5.0);
	...
	DrugText = CreateDynamic3DTextLabel(strings, COLOR_GREY, -2813.33, -1516.67, 141.144, 5.0); // product marijuana

	CargoMeatPickup = CreateDynamicPickup(1239, 23, 2228.3291, -2268.3794, 14.7647, -1, -1, -1, 5.0);
	format(strings, sizeof(strings), ""AQUA"[MEAT]\n"YELLOW_E"Cargo Box Stock: "WHITE_E"%d\n\n"YELLOW_E"Cargo Price: "WHITE_E"$70.0", ServerCargoMeat);
	cMeatText = CreateDynamic3DTextLabel(strings, COLOR_WHITE, 2228.3291, -2268.3794, 14.7647, 5.0); //Cargo of meat
