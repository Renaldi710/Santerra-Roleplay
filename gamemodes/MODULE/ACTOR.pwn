...
{
	new string[256];
	format(string, sizeof(string), "{00FFFF}[ACTOR:%d]\n{FFFFFF}%s",actorid, ActorsInfo[actorid][aName]);
	...
	ActorsInfo[actorid][aTId] = CreateDynamic3DTextLabel(string, COLOR_WHITE, ActorsInfo[actorid][aPosX], ActorsInfo[actorid][aPosY], ActorsInfo[actorid][aPosZ]+0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, ActorsInfo[actorid][aVW], ActorsInfo[actorid][aInt], -1);
